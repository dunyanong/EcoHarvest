        ...
        <div className="md:px-5 w-full max-w-5xl mx-auto pt-20 pb-10 ">
            ...
            <div className="flex justify-center space-x-4 pt-5">
              <Link href='/auth/Login' legacyBehavior>
                <button className="group flex items-center rounded-full border border-black bg-black px-5 py-2 text-sm text-white transition-colors hover:bg-white hover:text-black gap-3">
                  <FaRecycle className="fill-current w-5 h-5" />    
                  <p>Get Started</p>          
                </button>              
              </Link>   
              <Link href='/location' legacyBehavior>
                <button className="group flex items-center rounded-full border border-black bg-white px-5 py-2 text-sm text-black transition-colors hover:bg-black hover:text-white gap-3">
                  <FaRecycle className="fill-current w-5 h-5" />    
                  <p>Location</p>          
                </button>            
              </Link>
            ...
            <div className="mx-1">
            <div className="mx-auto grid justify-center gap-4 md:grid-cols-2 pt-10">
