  ...
  return (
    <div className="mt-10">
      ...
      <div className="py-4 px-4">
        ...
        <p className="text-sm font-normal">Permanently remove your Personal Account and all of its contents from the EcoHarvest platform. This action is not reversible, so please continue with caution.</p>
